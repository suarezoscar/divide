...
export const FOOD_KEYWORDS: string[] = [
  ...
  // Restaurantes
  "restaurante", "restaurant", "bar", "cafeteria", "cafetería", "cafe", "café",
  "tasca", "venta", "meson", "mesón", "asadero", "freiduria", "freiduría",
  "marisqueria", "marisquería", "hamburgueseria", "hamburguesería", "creperia",
  "heladeria", "heladería", "churreria", "churrería", "pasticceria",
  "osteria", "trattoria", "bodegon", "bodegón", "taberna", "cantina",
  // Tapas / raciones
  "tapa", "tapas", "raciones", "pincho", "montadito", "banderilla", "gilda",
  "menu", "menú", "carta", "plato", "racion", "ración",
  "bocadillo", "bocata", "sandwich", "sándwich",
  // Fast food
  "burger", "hamburguesa", "perrito", "hotdog", "perro caliente",
  "patatas", "fritas", "bravas", "croquetas", "ensalada",
  ...
  "pizza", "pizzeria", "italiano", "italiana", "pasta", "lasaña", "lasana",
  "sushi", "japones", "japonés", "ramen", "yakisoba", "gyoza", "nigiri", "maki",
  ...
  "thai", "tailandes", "tailandés", "pad thai", "vietnamita", "pho",
  "coreano", "coreana", "bibimbap", "kimchi", "bulgogi", "kbbq",
  "griego", "griega", "musaka", "tzatziki", "souvlaki", "feta",
  "marroqui", "marroquí", "cuscus", "tajin", "pastela", "harira",
  "etiope", "etíope", "injera", "brasileño", "brasileña", "feijoada", "rodizio",
  // Cocina española
  "cocido", "potaje", "lentejas", "garbanzos", "fabada", "migas", "gazpacho",
  "salmorejo", "ajo blanco", "pisto", "tortilla", "cachopo", "callos", "caracoles",
  "rabo de toro", "cochinillo", "secreto", "presa ibérica", "presa iberica",
  "pan con tomate", "pan tumaca", "butifarra", "fuet",
  "pimientos de padrón", "pimientos del padron", "huevos rotos", "setas", "revuelto",
  "merluza", "bacalao", "bonito", "anchoas",
  "pulpo a la gallega", "zamburiñas", "zamburinas", "vieiras",
  "centollo", "nécora", "necora", "bogavante", "langosta",
  ...
  "jamon", "jamón", "serrano", "iberico", "ibérico", "bellota", "cecina",
  "lomo", "chorizo", "salchichon", "salchichón", "sobrasada", "morcilla",
  ...
  "marisco", "pescado", "carne", "chuleton", "chuletón", "entrecot", "solomillo",
  // Cocina latina
  "arepa", "empanada", "ceviche", "causa", "tiradito", "anticucho",
  "choripan", "choripán", "milanesa", "alfajor", "mate",
  ...
  "hipercor", "el corte ingles", "el corte inglés",
  "fruta", "verdura", "mercado", "fruteria", "frutería",
  "naranja", "manzana", "pera", "uva", "fresa", "melon", "melón", "sandia",
  "cereza", "kiwi", "mango", "papaya", "maracuya", "aguacate", "palta",
  "tomate", "lechuga", "cebolla", "ajo", "pimiento", "zanahoria", "patata",
  "calabacin", "berenjena", "esparrago", "espinaca", "brocoli", "brócoli",
  // Delivery
  "delivery", "glovo", "ubereats", "justeat", "deliveroo", "rappi", "pedidosya",
  "domicilio", "pedido", "encargar", "takeaway", "take away",
  // Menaje / cocina
  "sarten", "sartén", "cacerola", "cazuela", "puchero", "olla exprés",
