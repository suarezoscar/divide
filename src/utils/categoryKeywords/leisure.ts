export const LEISURE_KEYWORDS: string[] = [
  ...
  "discoteca", "disco", "fiesta", "club", "after", "noche", "pub", "bar musical",
  ...
  "discoteca", "club nocturno", "afterparty", "botellon", "botellón", "previa",
  "garito", "antro", "pachanga", "juerga", "farra", "marcha", "salir",
  "reserva mesa", "vip", "lista", "guest", "abono", "temporada",
